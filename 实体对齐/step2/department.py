...
def add_department(ontology,department_dict):
    ...
    department_line = '		<oboInOwl:department rdf:datatype="&xsd;string">%s</oboInOwl:department>'
...
if __name__ == '__main__':
    full_ontology_filepath = u'zh_gastrointestinal_step1.owl'
    new_ontology_filepath = u'zh_gastrointestinal_step2.owl'
