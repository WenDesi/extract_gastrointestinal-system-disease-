...
if __name__ == '__main__':
    # 需要改
    full_ontology_filepath = u'step4.owl'
    new_ontology_filepath = u'step4_ok.owl'
    ontology = read_ontology(full_ontology_filepath)

    # 需要改
    entity_filepath = 'complication.csv'
    entity = map(lambda x:x[0], read_csv(entity_filepath))

    # 需要改
    relation_filepath = 'disease_complication_relation.csv'
